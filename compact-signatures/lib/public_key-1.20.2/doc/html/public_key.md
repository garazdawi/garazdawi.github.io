# `public_key`
[🔗](https://github.com/erlang/otp/blob/master/lib/public_key/src/public_key.erl#L25)
...
# `decrypt_private(CipherText, Key) ≡ decrypt_private(CipherText, Key, [])`
*since OTP R14B* 
# `decrypt_private`
*since OTP R14B* 
...
# `decrypt_public(CipherText, Key) ≡ decrypt_public(CipherText, Key, [])`
*since OTP R14B* 
# `decrypt_public`
*since OTP R14B* 
...
# `encrypt_private(PlainText, Key) ≡ encrypt_private(PlainText, Key, [])`
*since OTP R14B* 
# `encrypt_private`
*since OTP 21.1* 
...
# `encrypt_public(PlainText, Key) ≡ encrypt_public(PlainText, Key, [])`
*since OTP R14B* 
# `encrypt_public`
*since OTP 21.1* 
...
# `pem_entry_decode(PemEntry) ≡ pem_entry_decode(PemEntry, "")`
*since OTP R14B* 
# `pem_entry_decode`
*since OTP R14B* 
...
# `pem_entry_encode(Asn1Type, Entity) ≡ pem_entry_encode/3`
*since OTP R14B* 
# `pem_entry_encode`
*since OTP R14B* 
...
# `sign(Msg, DigestType, Key) ≡ sign(Msg, DigestType, Key, [])`
...
# `verify(Msg, DigestType, Signature, Key) ≡ verify(Msg, DigestType, Signature, Key, [])`
*since OTP R14B* 
# `verify`
*since OTP 20.1* 
