...
# `addTextRaw(This, Text) ≡ addTextRaw(This, Text, [])`
...
# `appendTextRaw(This, Text) ≡ appendTextRaw(This, Text, [])`
...
# `findText(This, MinPos, MaxPos, Text) ≡ findText(This, MinPos, MaxPos, Text, [])`
...
# `markerDefine(This, MarkerNumber, MarkerSymbol) ≡ markerDefine(This, MarkerNumber, MarkerSymbol, [])`
...
# `styleSetFontAttr(This, StyleNum, Size, FaceName, Bold, Italic, Underline) ≡ styleSetFontAttr(This, StyleNum, Size, FaceName, Bold, Italic,
                 Underline, [])`
