...
# `append(This, Id, Item) ≡ append(This, Id, Item, [])`
...
# `appendCheckItem(This, Id, Item) ≡ appendCheckItem(This, Id, Item, [])`
...
# `appendRadioItem(This, Id, Item) ≡ appendRadioItem(This, Id, Item, [])`
...
# `insert(This, Pos, Id, Text, Submenu) ≡ insert(This, Pos, Id, Text, Submenu, [])`
...
# `insertCheckItem(This, Pos, Id, Item) ≡ insertCheckItem(This, Pos, Id, Item, [])`
...
# `insertRadioItem(This, Pos, Id, Item) ≡ insertRadioItem(This, Pos, Id, Item, [])`
...
# `prepend(This, Id, Text, Submenu) ≡ prepend(This, Id, Text, Submenu, [])`
...
# `prependCheckItem(This, Id, Item) ≡ prependCheckItem(This, Id, Item, [])`
...
# `prependRadioItem(This, Id, Item) ≡ prependRadioItem(This, Id, Item, [])`
