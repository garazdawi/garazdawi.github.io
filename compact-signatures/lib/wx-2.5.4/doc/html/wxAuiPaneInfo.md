# `wxAuiPaneInfo`
[🔗](https://github.com/erlang/otp/blob/master/lib/wx/src/gen/wxAuiPaneInfo.erl#L58)
...
# `bottomDockable(This) ≡ bottomDockable(This, [])`
...
# `captionVisible(This) ≡ captionVisible(This, [])`
...
# `closeButton(This) ≡ closeButton(This, [])`
...
# `destroyOnClose(This) ≡ destroyOnClose(This, [])`
...
# `gripperTop(This) ≡ gripperTop(This, [])`
...
# `leftDockable(This) ≡ leftDockable(This, [])`
...
# `maximizeButton(This) ≡ maximizeButton(This, [])`
...
# `minimizeButton(This) ≡ minimizeButton(This, [])`
...
# `paneBorder(This) ≡ paneBorder(This, [])`
...
# `rightDockable(This) ≡ rightDockable(This, [])`
...
# `topDockable(This) ≡ topDockable(This, [])`
