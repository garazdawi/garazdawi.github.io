# `shell`
[🔗](https://github.com/erlang/otp/blob/master/lib/stdlib/src/shell.erl#L22)
...
```erlang
-spec hints(Hints) -> OldHints when Hints :: boolean(), OldHints :: boolean().
```
