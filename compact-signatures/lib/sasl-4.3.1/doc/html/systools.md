# `systools`
[🔗](https://github.com/erlang/otp/blob/master/lib/sasl/src/systools.erl#L22)
...
# `make_relup(Name, UpFrom, DownTo) ≡ make_relup(Name, UpFrom, DownTo, [])`
...
# `make_script(Name) ≡ make_script/2`
