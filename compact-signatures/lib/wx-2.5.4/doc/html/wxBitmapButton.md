# `wxBitmapButton`
[🔗](https://github.com/erlang/otp/blob/master/lib/wx/src/gen/wxBitmapButton.erl#L58)
...
# `create(This, Parent, Id, Bitmap) ≡ create(This, Parent, Id, Bitmap, [])`
...
# `new(Parent, Id, Bitmap) ≡ new(Parent, Id, Bitmap, [])`
