# `wxSizer`
[🔗](https://github.com/erlang/otp/blob/master/lib/wx/src/gen/wxSizer.erl#L58)
...
# `add(This, Window) ≡ add(This, Window, [])`
...
# `addStretchSpacer(This) ≡ addStretchSpacer(This, [])`
...
# `insertStretchSpacer(This, Index) ≡ insertStretchSpacer(This, Index, [])`
...
# `prependStretchSpacer(This) ≡ prependStretchSpacer(This, [])`
