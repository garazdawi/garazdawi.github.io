...
# `fold(Function, Acc0, QH) ≡ fold(Function, Acc0, QH, [])`
...
# `keysort(KeyPos, QH1) ≡ keysort(KeyPos, QH1, [])`
...
# `next_answers(QueryCursor) ≡ next_answers(C, 10)`
...
# `string_to_handle(QueryString, Options) ≡ string_to_handle(QueryString, Options, erl_eval:new_bindings())`
