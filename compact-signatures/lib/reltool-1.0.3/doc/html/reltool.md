# `reltool`
[🔗](https://github.com/erlang/otp/blob/master/lib/reltool/src/reltool.erl#L22)
...
```erlang
-type mod() :: {incl_cond, incl_cond()} | {debug_info, debug_info()}.
```
...
# `get_config(PidOrOption) ≡ get_config(Server, false, false)`
