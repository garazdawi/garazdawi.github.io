# `gen_sctp`
[🔗](https://github.com/erlang/otp/blob/master/lib/kernel/src/gen_sctp.erl#L23)
...
[SCTP Socket Option](#options) name and value, to set.
...
[SCTP Socket Option](#options) name, to get.
...
# `connect(Socket, SockAddr, Opts) ≡ connect(Socket, SockAddr, Opts, infinity)`
*since OTP 24.3* 
# `connect`
...
# `connect_init(Socket, SockAddr, Opts) ≡ connect_init(Socket, SockAddr, Opts, infinity)`
*since OTP 24.3* 
# `connect_init`
*since OTP R13B04* 
...
# `connectx_init(Socket, Addrs, Port, Opts) ≡ connectx_init(Socket, Addrs, Port, Opts, infinity)`
*since OTP 25.0* 
# `connectx_init`
*since OTP 25.0* 
...
# `open(Port, Opts) ≡ open([{port, Port} | Opts])`
